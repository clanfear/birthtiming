...
invisible(pdftools::pdf_convert("diagram_model.pdf", filenames="diagram_model.png", dpi = 500, verbose=FALSE))
...
invisible(pdftools::pdf_convert("diagram_estimates.pdf", filenames="diagram_estimates.png", dpi = 500, verbose=FALSE))
